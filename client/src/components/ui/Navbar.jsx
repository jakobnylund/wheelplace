      ...
      <div className="px-5 sm:px-8"><div className="max-w-site mx-auto">
        ...
        {menuOpen && (
          <div className="lg:hidden pb-5">
            ...
            <Link to="/forfragningar" className="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl border border-brand-dark/20 text-brand-dark text-sm font-medium mb-3">
