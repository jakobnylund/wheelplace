  ...
  return (
    <div className="bg-white rounded-xl border border-brand-gray/40 overflow-hidden cursor-pointer transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 group">
      <div className="relative aspect-[4/3] bg-gradient-to-br from-brand-gray-light to-brand-gray/20 flex items-center justify-center overflow-hidden">
        ...
        {condition === 'new' && (
          <span className="absolute top-2.5 left-2.5 bg-green-100 text-green-800 text-[11px] font-bold px-2 py-0.5 rounded-md">Ny</span>
        )}
        {condition === 'used' && (
      ...
      <div className="p-3.5">
        ...
        <div className="flex items-center justify-between">
          <span className="text-[16px] font-bold text-brand-dark">{price}</span>
...
export default function SEOPage() {
  ...
  const tabs = [
    { id: 'falgar', label: 'Falgar' },
    { id: 'komplett', label: 'Kompletta hjul' },
    { id: 'dack', label: 'Dack' },
    { id: 'vinter', label: 'Vinterdack' },
  ];
  ...
  const listings = [
    ...
    { title: 'Nya sommarfalgar 20" XC60 II', specs: '20" · 5x108 · ET42 · 8.5J', price: '18 500 kr', location: 'Goteborg', condition: 'new' },
    { title: 'Original 18" 5x108 Volvo XC60', specs: '18" · 5x108 · ET43 · 7.5J', price: '6 200 kr', location: 'Malmo', condition: 'used' },
    { title: 'BBS SR 19" for Volvo 5x108', specs: '19" · 5x108 · ET40 · 8J', price: '22 000 kr', location: 'Uppsala', condition: 'new' },
    { title: 'Vinterdack Nokian 235/60R18 4st', specs: '235/60R18 · 7mm monster · DOT2024', price: '4 800 kr', location: 'Linkoping', condition: 'used' },
  ...
  return (
    <div className="bg-brand-gray-light min-h-screen">
      {/* Breadcrumb */}
      <div className="bg-white border-b border-brand-gray/30 px-5 md:px-8 py-3">
        <div className="max-w-[1200px] mx-auto">
          <nav className="text-[13px] text-brand-gray-medium flex items-center gap-1.5">
            ...
            <a href="/annonser-proto" className="hover:text-brand-blue transition-colors">Falgar</a>
            <span className="text-brand-gray">›</span>
      ...
      {/* Hero */}
      <div className="bg-gradient-to-br from-brand-blue-dark to-brand-blue text-white px-5 md:px-8 py-9">
        <div className="max-w-[1200px] mx-auto">
          <h1 className="text-[28px] font-bold font-heading mb-1.5">Falgar till Volvo XC60</h1>
          <p className="text-[15px] opacity-85">Bultcirkel 5x108 · Navhal 63,4 mm · 19 annonser tillgangliga just nu</p>
      ...
      {/* Main layout */}
      <div className="max-w-[1200px] mx-auto px-5 md:px-8 py-7 grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-7">
        {/* Sidebar */}
        <aside className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl border border-brand-gray/40 p-5">
            ...
            <div className="mt-3 pt-2 border-t border-brand-gray-light">
              <span className="text-brand-gray-medium font-medium text-[14px]">Rek. dackdimensioner</span>
            ...
            {/* Brake warning */}
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mt-4 text-[12.5px] text-amber-900 flex gap-2 items-start">
              <img src="/icons/warning-triangle.svg" alt="" className="w-4 h-4 mt-0.5 opacity-70 shrink-0" />
              <div>
                <strong>T8 Hybrid 2018–2020</strong><br />
                Kraver minimum 19" falg p.g.a. bromsok. Kontrollera din variant.
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#1e3a8a] to-brand-blue rounded-xl p-5 text-white">
            <h3 className="text-[14px] font-bold mb-1.5">Sok pa ditt regnummer</h3>
            <p className="text-[12px] opacity-80 mb-3.5 leading-relaxed">Fa exakt ratt dack- och falgrekommendation for just din XC60</p>
        ...
        <main className="min-w-0">
          ...
          <div className="bg-white rounded-xl border border-brand-gray/40 overflow-hidden mt-8">
            <div className="px-5 py-4 border-b border-brand-gray-light">
              <h2 className="text-[17px] font-bold text-brand-dark font-heading">Vanliga fragor om falgar till Volvo XC60</h2>
            </div>
            {[
              { q: 'Vilken bultcirkel har Volvo XC60?', a: 'Alla generationer av Volvo XC60 anvander bultcirkeln 5x108, vilket ar standard for Volvo-modeller.' },
              { q: 'Vilka falgstorlekar passar XC60?', a: 'Beroende pa generation passar 17" till 22". OEM-storlekarna ar vanligtvis 18" och 19". For T8-modeller kravs minst 19" p.g.a. storlek pa bromsok.' },
              { q: 'Kan jag anvanda falgar fran andra Volvo-modeller?', a: 'Ja, manga Volvo-modeller delar bultcirkeln 5x108, t.ex. XC90, S60, V60 och V90. Kontrollera ET-offset och navhal for att sakerstalla kompatibilitet.' },
              { q: 'Vad ar ratt ET-offset for XC60?', a: 'Standard ET-offset for Volvo XC60 ar 40,5–50,5 mm beroende pa falgbredd och generation.' },
            ].map((faq, i) => (
          ...
          <div className="bg-white rounded-xl border border-brand-gray/40 p-6 mt-5">
            <h2 className="text-[17px] font-bold text-brand-dark font-heading mb-3">Kop falgar till Volvo XC60 online</h2>
            <p className="text-[13.5px] text-brand-gray-medium leading-relaxed mb-2.5">
              Pa Wheelplace hittar du ett brett utbud av falgar, kompletta hjul och dack som passar din Volvo XC60. Alla annonser valideras mot bilens specifikationer sa att du kan handla med trygghet.
            </p>
            <p className="text-[13.5px] text-brand-gray-medium leading-relaxed mb-4">
              Volvo XC60 anvander bultcirkeln 5x108 med ett navhal pa 63,4 mm. Beroende pa motorvariant och arsmodell kan falgstorlekar variera fran 17" upp till 22".
            </p>
