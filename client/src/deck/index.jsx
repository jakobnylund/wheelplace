...
function SlideAsk() {
  return (
    <Slide>
      <div className="px-14 pt-14">
        <Tag>Rundan</Tag>
        <H1 className="mt-3 max-w-[700px]">8 MSEK totalt — strategisk partner för ~10 %</H1>
        ...
        <div className="mt-8 flex gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="mt-5 bg-brand-gray-light rounded-xl p-5">
              <div className="text-[12px] font-semibold text-brand-gray-medium uppercase tracking-wider mb-3">Användning av kapital (4 MSEK nyemission)</div>
              <div className="space-y-2">
                {[
                  ['Marknadsföring & kundförvärv', '50 %', '2M', 'w-1/2'],
                  ['Produktutveckling', '25 %', '1M', 'w-1/4'],
